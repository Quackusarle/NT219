...
urlpatterns = [
    ...
    path('error-access-denied/', views.error_access_denied_view, name='rs_error_access_denied'),
    ...
    path('api/debug/cpabe/<uuid:entry_id_uuid>/', views.DebugCPABEView.as_view(), name='api_debug_cpabe'),
]